...
const FormUpdateVideo = ({ isModalOpenUpdate, setIsModalOpenUpdate, handleUpdateClick, selectedItem }) => {
  ...
  const handleSubmit = (e) => {
    ...
    fetch('http://localhost:8080/api/v1/videoeducation' + `/${selectedItem.id}`, {
      method: 'PUT',
      headers: {
  ...
  return (
    <div className="form-modal">
      <form onSubmit={handleSubmit}>
        ...
        <label>
          Đường dẫn video:
          <input type="text" name="video_url" value={formData.video_url} onChange={handleChange} required />
        </label>
        {/* <label>
          Đường dẫn liên kết:
