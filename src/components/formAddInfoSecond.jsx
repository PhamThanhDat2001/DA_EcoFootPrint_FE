...
const FormPostInfoSecond = ({ isModalOpenAdd, setIsModalOpenAdd, handleAddClick }) => {
  ...
  const handleSubmit = (e) => {
    ...
    fetch('http://localhost:8080/api/v1/infomationsecond', {
      method: 'POST',
      headers: {
...
export default FormPostInfoSecond;
