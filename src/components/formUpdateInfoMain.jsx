...
const FormUpdateInfoMain = ({ isModalOpenUpdate, setIsModalOpenUpdate, handleUpdateClick, selectedItem }) => {
  ...
  const handleSubmit = (e) => {
    ...
    fetch('http://localhost:8080/api/v1/infomationmain' + `/${selectedItem.id}`, {
      method: 'PUT',
      headers: {
...
export default FormUpdateInfoMain;
