...
const FormUpdateNewSpaper = ({ isModalOpenUpdate, setIsModalOpenUpdate, handleUpdateClick, selectedItem }) => {
  ...
  const handleSubmit = (e) => {
    ...
    fetch('http://localhost:8080/api/v1/newspaper' + `/${selectedItem.id}`, {
      method: 'PUT',
      headers: {
...
export default FormUpdateNewSpaper;
