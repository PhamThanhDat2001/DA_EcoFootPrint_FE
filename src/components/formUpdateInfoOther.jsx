...
const FormUpdateInfoOther = ({ isModalOpenUpdate, setIsModalOpenUpdate, handleUpdateClick, selectedItem }) => {
  ...
  const handleSubmit = (e) => {
    ...
    fetch('http://localhost:8080/api/v1/infomationother' + `/${selectedItem.id}`, {
      method: 'PUT',
      headers: {
...
export default FormUpdateInfoOther;
