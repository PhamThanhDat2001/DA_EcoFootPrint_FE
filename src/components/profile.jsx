...
import unsplash1 from "../img/avatars/unsplash-1.jpg";
import unsplash2 from "../img/avatars/unsplash-2.jpg";
...
const ProfileDetails = () => {
  ...
  <Card>
    ...
    <CardBody className="text-center">
      <img
        src={userInfo.avatarUrl ?'https://www.shutterstock.com/image-vector/user-profile-icon-vector-avatar-600nw-2247726673.jpg'  :{avatar4}}
        alt="Stacie Hall"
      ...
      <div className="text-muted mb-2"><strong>ROLE: {userInfo.role}</strong></div>
    ...
    <CardBody>
      ...
      <li className="mb-1">
          <Home width={14} height={14} className="mr-1" /> Họ và tên{" "}
          <Link to="/dashboard/default">{userInfo.fullname}</Link>
        </li>
        <li className="mb-1">
          <Home width={14} height={14} className="mr-1" /> Giới tính{" "}
          <Link to="/dashboard/default">{userInfo.gender}</Link>
        </li>
        <li className="mb-1">
          <Home width={14} height={14} className="mr-1" /> Ngày sinh{" "}
          <Link to="/dashboard/default">{userInfo.birthday}</Link>
        </li>
        <li className="mb-1">
          <Home width={14} height={14} className="mr-1" /> Sống ở{" "}
          <Link to="/dashboard/default">{userInfo.address}</Link>
        </li>

        <li className="mb-1">
          <Briefcase width={14} height={14} className="mr-1" /> Email{" "}
          <Link to="/dashboard/default">{userInfo.email}</Link>
        </li>
        <li className="mb-1">
          <MapPin width={14} height={14} className="mr-1" /> From{" "}
          <Link to="/dashboard/default">Việt Nam</Link>
        </li>
      </ul>
    </CardBody>
    <hr className="my-0" />
    <CardBody>
      <CardTitle tag="h5">Liên kết khác</CardTitle>
        ...
        <Media body>
          ...
          <div className="row no-gutters mt-1">
            <div className="col-6 col-md-4 col-lg-4 col-xl-3">
              <img src={unsplash1} className="img-fluid pr-2" alt="Unsplash" width="128"
        height="128"/>
            </div>
            <div className="col-6 col-md-4 col-lg-4 col-xl-3">
              <img src={unsplash2} className="img-fluid pr-2" alt="Unsplash"  width="128"
        height="128"/>
            </div>
          </div>
          <Button size="sm" color="danger" className="mt-1">
...
const Profile = () => (
  <Container fluid className="p-0">
    <h1 className="h3 mb-3">Trang cá nhân<nav></nav></h1>
